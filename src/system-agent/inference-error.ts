...
export class SystemAgentInferenceUnavailableError extends Error {
  ...
  constructor(
    ...
    super(
      "OpenClaw could not reach working inference. Reconnecting AI happens on the machine running OpenClaw, with `openclaw onboard` — it live-tests the route before saving it. Then try again.",
    );
